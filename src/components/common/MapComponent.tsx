...
const featuredIcon = createCircleIcon("#1F78B4", 20, true);
const otherIcon    = createCircleIcon("#E31A1C", 12, false);
...
export default function MapComponent({ stations, featuredStation }: any) {
  ...
  return (
    <div id="mapa-seccion" className="relative h-[500px] w-full rounded-[34px] overflow-hidden border border-slate-200 mt-10">
